...
class RollRateTelemetry:
    """Telemetry required for roll/pitch inner-loop and outer-loop testing."""
...
# 如果你想保留“state”这个名字，也可以用这个；本质上和 output 很接近
@dataclass(frozen=True)
class OuterLoopState:
    """Latest outer-loop state for GUI/debug display."""
