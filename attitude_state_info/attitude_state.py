...
class AttitudeState:
    ...
    In Python this is lighter than a heavy static Java-style class, while still giving
    one shared state object across facade and GUI.
    """
    ...
    def update_from_raw(
        ...
        *,
        ...
        # and uses roll/pitch from KSP flight telemetry.
